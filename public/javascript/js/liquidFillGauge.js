...
function liquidFillGaugeDefaultSettings(){
    return {
        ...
        waveColor: "#246D5F9", // The color of the fill wave.
        waveOffset: 0.25, // The amount to initially offset the wave. 0 = no offset. 1 = offset of one full wave.
        textVertPosition: .5, // The height at which to display the percentage text withing the wave circle. 0 = bottom, 1 = top.
        textSize: 1.2, // The relative height of the text to display in the wave circle. 1 = 50%
        valueCountUp: true, // If true, the displayed value counts up from 0 to it's final value upon loading. If false, the final value is displayed.
        displayPercent: false, // If true, a % symbol is displayed after the value.
        textColor: "#0E5144", // The color of the value text when the wave does not overlap it.
        waveTextColor: "#6DA398" // The color of the value text when the wave overlaps it.
    };
};
